...
const int A_CLK_PIN = 2;    // Azul - INT0
const int B_DT_PIN = 3;     // Blanco - INT1
const int IN1 = 8;
const int IN2 = 9;
const int ENA = 10;
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(A_CLK_PIN), updateEncoder, CHANGE);
  //attachInterrupt(digitalPinToInterrupt(B_DT_PIN), updateEncoder, CHANGE);
}
...
void updateEncoder(){
  ...
  // Si el último estado actual del CLK es distinto, entonces ocurrió un pulso
